    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8">Hello, I'm Hamza Belkadi, web development enthusiast from
                    Morocco. I hold a Higher Technician's Certificate (BTS) in Multimedia and Web Design. My coding
                    journey began with experimenting on Discord bots. Now, I create beautiful and responsive websites
                    for everyone to explore. My main goal in coding is simple: to create things that look great and
                    serve a purpose. Whether it's designing sleek interfaces or developing robust web applications, I'm
                    always looking for new ideas to create something impressive.
                </p>
...
const education = ref([
    {
        id: 1,
        school: "Higher Technician's Certificate",
        program: 'Diploma in Multimedia and Web Design',
        year: '2022-2024',
    },
    {
        id: 2,
