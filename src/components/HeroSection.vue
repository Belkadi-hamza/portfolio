            ...
            <div
                ...
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        Passionate frontend and backend developer crafting beautiful, responsive websites with precision
                        and purpose.
                    </p>
                        ...
                        <button
                            ...
                            <div
                                ...
                                <div class="svg-container">
                                    ...
                                    20.1213C16.6839 19.5587 17 18.7956 17 18V17" stroke="#f59e0b" stroke-width="2"
                                            stroke-linecap="round" />
                                    </svg>
                                    <div class="download-loader text-white hidden"></div>
                                </div>
                                <a :href="resum" :download="resum" class="pl-2 text-primary">Download
                                    resume</a>
                            </div>
                        </button>
                    </div>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        <a :href='linkedinURL' target="_blank" class="border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            <img :src='linkedin' :alt='linkedin'>
                        </a>
                        <a :href='githubURL' target="_blank" class="border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            <img :src='github' :alt='github'>
                        </a>
                        <a :href='instagramURL' target="_blank" class="border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                ...
                <div class="lg:h-full md:flex">
                    <div
                        ...
                        <div
                            ...
                            <img :src='me' alt="My pictur" width="500" height="auto" loading="lazy"
...
<script setup>
import AOS from 'aos';
import resum from './../assets/resum/resum.pdf';
...
const linkedinURL = "https://www.linkedin.com/in/hamza-belkadi-81a756292/"
const githubURL = "https://github.com/Belkadi-hamza"
const instagramURL = "https://www.instagram.com/belkadi.hamza.391?igsh=OGRuMjE2dmVxaGh1"
AOS.init();
</script>
